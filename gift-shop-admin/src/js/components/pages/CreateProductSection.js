...
import { ClearToastShow, NavTogglerChangeMenu, ProductMenuChange, ToastSuccessShow } from "../../slice/Navbarslice";
...
export default function CreateProductSection() {
  ...
  const {success,loading} = useSelector((state)=>state.ProductState);
  ...
  useEffect(()=>{
    if(success){
        dispatch(ToastSuccessShow('Product Created SuccessFully'))
        ...
        <div className="right-content mt-5 mx-md-5 mx-lg-0 overflow-v h-100 mb-5">
          <div>
            ...
            <div className="dashboarrd-head mx-3">
              <h3 className="text-light ">Create Product</h3>
              <div
                onClick={() =>
                  navToogle
            ...
            <div className="sc-card mt-4 ms-3">
              ...
              <form action="post" onSubmit={CreateProductFuction} className="row px-3">
                ...
                <div className="col-12 my-3">
                  <button type="submit" disabled={loading} className="btn-sc-primary rounded-pill w-100 display-flex gap-3">
                    <span>Create</span>
